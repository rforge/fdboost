...
The analysis is based on the analysis in the online appendix of Scheipl et al. (2015). 
...
\item[] Scheipl, F., Staicu, A.-M., and Greven, S. (2015), Functional Additive Mixed Models, \textit{{Journal of Computational and Graphical Statistics}}, 24(2), 477-501.
\end{itemize}
